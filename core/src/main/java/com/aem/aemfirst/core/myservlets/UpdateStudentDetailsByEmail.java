...
property={
        Constants.SERVICE_DESCRIPTION + "=UpdateStudentDetailsByEmail Servlet",
        "sling.servlet.methods=" + HttpConstants.METHOD_POST,
		/*
		 * "sling.servlet.resourceTypes="+ "ayansh/components/structure/page",
		 * "sling.servlet.extensions=" + "txt"
		 */
        "Sling.servlet.paths="+"/bin/updateStudentDetailsByEmail"
})
public class UpdateStudentDetailsByEmail extends SlingAllMethodsServlet {
	@Reference
	CrudInt stdUpdate;
...
protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response)
	...
	try {
		boolean b=stdUpdate.updateStudentDetails(firstName, lastName, email);
		if (b) {
